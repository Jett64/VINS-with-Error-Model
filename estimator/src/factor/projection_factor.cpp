...
ProjectionFactor::ProjectionFactor(const Eigen::Vector3d &_pts_i, const Eigen::Vector3d &_pts_j, const double _CL_i, const double _CL_j) 
    : pts_i(_pts_i), pts_j(_pts_j), CL_i(_CL_i), CL_j(_CL_j) 
{
...
bool ProjectionFactor::Evaluate(double const *const *parameters, double *residuals, double **jacobians) const
{
    ...
    residual = sqrt_info * residual / (1 / CL_j);  // information matrix: sqrt_info / (1 / CL_j)
    ...
    if (jacobians)
    {
        ...
        #endif
        reduce = sqrt_info * reduce / (1 / CL_j);  // information matrix: sqrt_info / (1 / CL_j)
...
void ProjectionFactor::check(double **parameters)
{
    ...
    for (int k = 0; k < 19; k++)
    {
        ...
        #endif
        tmp_residual = sqrt_info * tmp_residual / (1 / CL_j);  // information matrix: sqrt_info / (1 / CL_j)
